<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
  ...
  <div class="sidenav-header">
    <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-100 position-absolute end-0 top-0 d-none d-xl-none"
      aria-hidden="true" id="iconSidenav"></i>
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      <img src="../assets/img/logos/maju_motor.png" class="navbar-brand-img h-100" alt="...">
      <span class="ms-3 font-weight-bold">MAJU MOTOR</span>
    </a>
  </div>
  <hr class="horizontal dark my-2">
  <div class="collapse navbar-collapse mt-2 w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav mt-2">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('jasa') ? 'active' : '') }}" href="{{ url('jasa') }}">
          ...
          <span class="nav-link-text ms-1">Jasa</span>
        </a>
      </li>
      <li class="nav-item mt-4">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Jual</h6>
      </li>
      <li class="nav-item">
