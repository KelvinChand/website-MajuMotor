                                                ...
                                                @if ($i === 0)
                                                    ...
                                                    <td class="text-start" rowspan="{{ $totalRows }}">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
    <!-- Tombol Cetak -->
    <a href="{{ route('penjualan.print', $penjualanProduk->idPenjualan) }}" target="_blank"
        class="btn bg-gradient-info btn-sm mb-0">
        <svg width="12px" height="12px" viewBox="0 0 24 24" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M6 9V4h12v5" stroke="#FFFFFF" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round" />
            <path d="M6 18h12v2H6z" fill="#FFFFFF" />
            <path d="M6 14h12v4H6z" stroke="#FFFFFF" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round" />
        </svg> Cetak
    </a>

    <!-- Tombol Hapus -->
    <form action="{{ route('penjualan.destroy', $penjualanProduk->idPenjualan) }}" method="POST">
        @csrf
        @method('DELETE')
        <button type="submit"
